...
| :----- | :-------------------------------------------------------- | :--------------------------------------------------------------------------------- |
| **-5** | `argo-cd`                                                 | Argo CD manages itself first to ensure the controller is up-to-date.               |
| **-4** | `sealed-secrets`, `metallb`, `nfs-csi`, `reloader`, `nfd` | Foundational infrastructure: Networking, Secrets, Storage, and Hardware Discovery. |
